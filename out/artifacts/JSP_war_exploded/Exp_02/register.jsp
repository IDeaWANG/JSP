...
<form name="input" action="doRegister.jsp" method="POST">
    <table border="1">
        ...
        <tr>
            <td>密码</td>
            <td>
                <input type="password" align="center" name="passwd"/>
        ...
        <tr>
            <td>爱好兴趣</td>
            <td>
                <input type="checkbox" name="habbit" value="Internet"/>网络<br>
                <input type="checkbox" name="habbit" value="Sport"/>运动<br>
                <input type="checkbox" name="habbit" value="Swimm"/>游泳
            </td>
        </tr>
        <tr>
